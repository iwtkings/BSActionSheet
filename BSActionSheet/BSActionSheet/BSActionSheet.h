...
@property (nonatomic, strong) UIColor *colorTxtTitle;

@property (nonatomic, strong) UIFont *fontTitle;

@property (nonatomic, strong) NSString *txtCancel;

@property (nonatomic, strong) UIColor *colorBtnCancel;
 ...
 *  @param contents          内容(字符串数组或者字典数组)
 (字典格式如下:{BSActionSheetContentTitleKey: "aa", BSActionSheetContentColorKey: [UIColor greenColor]})
